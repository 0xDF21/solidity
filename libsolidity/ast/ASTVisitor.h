...
public:
	...
	virtual bool visit(BuiltinDefinition& _node) { return visitNode(_node); }
	///  @}
	...
	virtual void endVisit(BuiltinDefinition& _node) { endVisitNode(_node); }
	///  @}
...
public:
	...
	virtual bool visit(BuiltinDefinition const& _node) { return visitNode(_node); }
	///  @}
	...
	virtual void endVisit(BuiltinDefinition const& _node) { endVisitNode(_node); }
	///  @}
