...
public:
	...
	struct Annotation
	{
		...
		// For builtin definitions, type definitions, type class definitions, type names and type name expressions.
...
private:
	...
	bool visit(BuiltinDefinition const& _builtinDefinition) override;
